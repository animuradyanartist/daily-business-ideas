...
_Generated 2026-09-14T08:07:38.259Z by `node scripts/pilot.mjs check`. Automated checks; read the evidence file for the full assessments._
...
Validators re-applied offline to the stored raw model output of that run at 2026-09-14T08:07:38.130Z (no new model call).
...
| Validation actually intervened where the model over-claimed (informational) | pass | 0 citation(s) rejected · 5 level/kind downgrade(s) · 12 claim(s) dropped · 0 sentence(s) removed |
