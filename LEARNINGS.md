...
- AI rewriters (Grammarly, Professionally.ai) raised the price ceiling for one-time-fee browseable artifacts rather than killing them. Subscriptions feel like rentals; a swipe file feels owned and studyable.
- Designer founders win in language-learning by turning text lists into filterable Notion artifacts plus Canva-editable PDFs. Easlo and Kazuki are the proof.
- "Unbundling enterprise B2B" is a workable frame: any company selling Business-English curriculum to corporates ($200+/mo) implies an individual buyer who can't expense it and would pay $39 for a focused slice.
- Reddit + LinkedIn-group + TikTok Reels is the realistic distribution stack for non-native tech professionals. They live in r/cscareerquestions, r/ExperiencedDevs, country-specific LinkedIn groups, and short-form video.
- Day-1 baseline conviction must be quantified. Floor: $5k year-1 from <150 sales at $39. Future ideas must beat both the floor math and the wedge clarity.
